...
import s from './Contacts_Completed.css';
import history from '../../history.js'
class Contacts_Completed extends React.Component {
  static propTypes = {
        ...
        <div className={s.container} style={{margin:'100px 200px 0px 100px'}}>
          ...
          <div className = {s.buttonlayout}>
            <ButtonToolbar>
              ...
              <Button bsStyle="primary" href="/contacts/completed" onClick={this.transition}> Completed trades </Button>
              <Button href="/contacts/cancelled" onClick={this.transition}> Cancelled trades </Button>
            </ButtonToolbar>
          </div>
          <div >
            <div className = {s.hyperlink}>
              <h2>Closed trades, finished</h2>
            </div>
            <div>
              <nav aria-label="...">
                <ul class="pager">
...
export default withStyles(s)(Contacts_Completed);
