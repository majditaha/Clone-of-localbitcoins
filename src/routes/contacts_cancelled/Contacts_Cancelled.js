...
import s from './Contacts_Cancelled.css';
import history from '../../history.js'
class Contacts_Cancelled extends React.Component {
  static propTypes = {
        ...
        <div className={s.container} style={{margin:'100px 200px 0px 100px'}}>
          ...
          <div className = {s.buttonlayout}>
            <ButtonToolbar>
              ...
              <Button bsStyle="primary" href="/contacts/cancelled" onClick={this.transition}> Cancelled trades </Button>
            </ButtonToolbar>
          </div>
          <div >
            <div className = {s.hyperlink}>
              <h2>Closed trades, cancelled</h2>
            </div>
            <div>
              <nav aria-label="...">
                <ul class="pager">
...
export default withStyles(s)(Contacts_Cancelled);
